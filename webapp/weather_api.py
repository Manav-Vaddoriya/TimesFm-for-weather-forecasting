...
Functions:
    ...
    fetch_historical_temps() – fetch the last N hours of hourly temperature
    fetch_current_weather()  – current temp / humidity / wind
"""
...
def fetch_historical_temps(lat: float, lon: float, hours: int = HISTORY_HOURS) -> list[dict]:
    """
    ...
    """
    # past_days must cover at least ceil(hours/24) days
